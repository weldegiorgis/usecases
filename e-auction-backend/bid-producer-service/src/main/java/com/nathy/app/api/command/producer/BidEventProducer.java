...
public class BidEventProducer {
	...
	public void sendBidEvent(BidRequest createBidCommand) throws JsonProcessingException {
    ...
    public void sendBidEvent_Approach2(BidRequest createBidCommand) throws JsonProcessingException {
	...
	public SendResult<Integer, String> sendBidEventSynchronous(BidRequest createBidCommand) throws JsonProcessingException, ExecutionException, InterruptedException, TimeoutException {
